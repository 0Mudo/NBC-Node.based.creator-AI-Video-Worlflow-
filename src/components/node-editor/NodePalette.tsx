...
export default function NodePalette({ collapsed: externalCollapsed, onToggleCollapse }: NodePaletteProps) {
  ...
  const handleAdd = (type: NodeType) => {
    const id = getId()
    const labelMap: Record<string, string> = { assetInput: '素材输入', characterCard: '角色卡', sceneCard: '场景卡', itemCard: '物品卡', script: '剧本/分镜', prompt: '提示词', gptImage2: 'GPT图像生成', banana: 'Banana图像生成', seedance: 'Seedance视频生成', output: '输出' }
